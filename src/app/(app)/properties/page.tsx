...
import { propertiesListingData, propertyPageFaqs } from '@/data/properties-data'
  ...
  return (
    <div className="main-wrapper">
      ...
      <section className="properties-hero">
        <h1 className="properties-hero-title">ROI PROPERTIES</h1>
      </section>
      ...
      <main className="container section-padding">
        ...
        <div className="catalog-grid" id="properties-grid">
          {propertiesListingData.map((item) => (

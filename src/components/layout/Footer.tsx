      ...
      <div className="container">
        <div className="footer-grid">
          ...
          <div className="footer-logo-desc">
            ...
            <div className="footer-btn-group" style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
              <Link href="/contact" className="footer-btn-book">
                BOOK A CALL
              </Link>
              <Link href="/roi-properties" className="footer-btn-invest">
                INVEST
              </Link>
            </div>
          </div>
          ...
          <div>
            ...
            <ul
              ...
              style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '0.4rem' }}
            >
              <li>
                <Link href="/roi-properties" className="footer-nav-link">
                  ROI Properties
                </Link>
              </li>
              <li>
                <Link href="/branded-residences" className="footer-nav-link">
                  Branded Residences
                </Link>
              </li>
              <li>
                <Link href="/other-properties" className="footer-nav-link">
                  Other Properties
                </Link>
              </li>
              <li>
